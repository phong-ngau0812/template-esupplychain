<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Customer_Add.aspx.cs" Inherits="Customer_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                           ...
                           <%-- <div class="form-group">
                                ...
                                <telerik:RadComboBox RenderMode="Lightweight" MaxHeight="300px"  ID="ddlCustomerType" Skin="MetroTouch" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Chọn nhóm khách hàng " Localization-ItemsCheckedString="nhóm khách hàng được chọn">
