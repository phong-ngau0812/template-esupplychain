<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="WarehouseExport_Edit.aspx.cs" Inherits="WarehouseExport_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" Enabled="false" ID="ddlProductBrand" OnSelectedIndexChanged="ddlProductBrand_SelectedIndexChanged" AutoPostBack="true" CssClass="select2 form-control" Width="100%" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Bạn chưa chọn doanh nghiệp"></asp:DropDownList>
                            </div>

                            <div class="form-group" runat="server" id="Nhom4">
                                <div class="form-group">
                                    <label>Tên phiếu xuất<span class="red">*</span> </label>
                                    <asp:TextBox runat="server" ID="txtTenPhieu" CssClass="form-control" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    ...
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel1" runat="server">
                                        <telerik:RadTreeList RenderMode="Lightweight" runat="server" ID="RadTreeList1"  DataKeyNames="ID" ParentDataKeyNames="Parent_ID"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:TreeListBoundColumn DataField="Name" HeaderText="Tên các lô đã xuất" UniqueName="Name">
                                                </telerik:TreeListBoundColumn>
                                                <telerik:TreeListBoundColumn DataField="AmountInWareHouse" HeaderText="Số lượng còn lại lô đã xuất" UniqueName="AmountInWareHouse">
                                                </telerik:TreeListBoundColumn>
                                                <telerik:TreeListTemplateColumn DataField="AmountExport" HeaderText="Số lượng đã xuất kho" UniqueName="AmountExport">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="txtQuantity" ClientIDMode="Static" CssClass="form-control" Text='<%#Eval("AmountExport") %>' min="0"></asp:TextBox>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><%#Eval("NameMaterial") %>
                                                            <asp:Literal runat="server" ID="lblMaterial_ID" Text='<%#Eval("Material_ID") %>' Visible="false"></asp:Literal>
                                                            <asp:Literal runat="server" ID="lblWarehouseExportMaterial" Text="" Visible="false"></asp:Literal>
                                                            <asp:Literal runat="server" ID="lblWarehouseImport_ID" Text='<%#Eval("WarehouseImport_ID") %>' Visible="false"></asp:Literal>
