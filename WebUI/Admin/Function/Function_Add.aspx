<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Function_Add.aspx.cs" Inherits="Function_Add" ValidateRequest="false" EnableEventValidation="false" %>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                           ...
                           <%-- OnSelectedIndexChanged="ddlFunctionGroupCategory_SelectedIndexChanged"--%>
                           <%-- AutoPostBack="true"--%>
                            <div class="form-group">
                                 <label>Tên nhóm menu <span class="red"> *</span> </label>
                                <asp:DropDownList runat="server" ID="ddlFunctionGroupMenu"  CssClass="select2 form-control" Width="100%"   data-parsley-required="true" data-parsley-allselected="true"  data-parsley-required-message="Bạn chưa chọn nhóm menu"  ></asp:DropDownList>
                            </div>
