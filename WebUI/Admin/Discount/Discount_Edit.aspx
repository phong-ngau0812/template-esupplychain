<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Discount_Edit.aspx.cs" Inherits="Discount_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Discount_List.aspx">Quản lý chiết khấu</a></li>
                ...
                <div class="col-lg-12"  >
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên chiết khấu <span style="color:red; font-size:15px"> *</span> </label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required  data-parsley-required="true" data-parsley-allselected="true"  data-parsley-required-message="Bạn chưa nhập tên chiết khấu"></asp:TextBox>

                            </div>

                            <div class="form-group">
                                <label>Chiết khấu (%) <span style="color:red; font-size:15px"> *</span> </label>
                                <asp:TextBox runat="server" ID="txtPercent" ClientIDMode="Static" CssClass="form-control" required data-parsley-required="true" data-parsley-allselected="true"  data-parsley-required-message="Bạn chưa nhập chiết chiết khấu" TextMode="Number" Width="100px"></asp:TextBox>
