<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Discount_Add.aspx.cs" Inherits="Discount_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtPercent" ClientIDMode="Static" CssClass="form-control" required data-parsley-required="true" data-parsley-allselected="true"  data-parsley-required-message="Bạn chưa nhập tên chiết khấu" TextMode="Number" Width="100px"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Mô tả</label>
