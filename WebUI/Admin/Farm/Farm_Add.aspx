<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Farm_Add.aspx.cs" Inherits="Farm_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Farm_List.aspx">Quản lý thửa/lô  </a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên Thửa/lô  <span style="color: red; font-size: 15px">*</span> </label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập thửa/lô"></asp:TextBox>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Trạng thái thửa/lô <span style="color: red; font-size: 15px">*</span> </label>
