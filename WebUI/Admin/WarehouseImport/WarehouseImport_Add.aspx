<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="WarehouseImport_Add.aspx.cs" Inherits="WarehouseImport_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtCode" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập mã số lô"></asp:TextBox>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" runat="server" id="Product">
                                ...
                                <asp:DropDownList runat="server" ID="ddlProduct" CssClass="select2 form-control" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group" runat="server" id="NCC">
                                <label>Nhà cung cấp</label>
                                <asp:DropDownList runat="server" ID="ddlSupplier" CssClass="select2 form-control" Width="100%" OnSelectedIndexChanged="ddlSupplier_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group" runat="server" id="NameMaterial">
                                <label>Tên vật tư đã có trong doanh nghiệp </label>
                                <asp:DropDownList runat="server" ID="ddlMaterial" CssClass="select2 form-control" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="ddlMaterial_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap" id="myTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptProductPackage" OnItemDataBound="rptProductPackage_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox runat="server" ID="txtQuantity" ClientIDMode="Static" CssClass="form-control" min="0" Text="0"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <%#Eval("Unit") %>
                                                    </td>
                                        ...
                                        <tr class="table-warning">
                                            ...
                                            <td colspan="4">
                                                <asp:Label runat="server" ID="total_sum_value" Text="0"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Người giao<span class="red">*</span> </label>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <asp:Button runat="server" ID="btnFake" ClientIDMode="Static" OnClick="btnFake_Click" CssClass="btn btn-gradient-primary waves-effect waves-light none" Text="Lưu" />
