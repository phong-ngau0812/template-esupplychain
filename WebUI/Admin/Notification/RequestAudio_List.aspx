<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="RequestAudio_List.aspx.cs" Inherits="Admin_Notification_RequestAudio_List" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a>Quản lý yêu cầu thêm mới âm thanh</a></li>
                                <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Danh sách thêm mới âm thanh</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                            ...
                                            <asp:Repeater runat="server" ID="grdData" OnItemDataBound="grdData_ItemDataBound" OnItemCommand="grdData_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <asp:Literal runat="server" ID="lblProductChange_Status" Text='<%#Eval("AudioRequest_Status") %>' Visible="false"></asp:Literal>
                                                            <asp:Literal runat="server" ID="lblProduct_ID" Text='<%#Eval("AudioRequest_ID") %>' Visible="false"></asp:Literal>
                                                           
                                                            <%#Eval("AudioRequest_Status").ToString()=="0"?"<span class='text-danger'> Chưa duyệt</span>": (Eval("AudioRequest_Status").ToString()=="2"?"<span class='text-danger'> Không duyệt</span>":"<span class='text-success'> Đã duyệt</span> ") %></td>
                                                        <td align="center">
                                                            <span>
                                                                <asp:LinkButton runat="server" ID="btnActive" CommandName="Active" CssClass=" btn btn-success mr-2" ToolTip="Duyệt" CommandArgument='<%#Eval("AudioRequest_ID") %>'>Duyệt</asp:LinkButton>
                                                                <a href='/Admin/Audio/AudioRequest_Edit?AudioRequest_ID=<%#Eval("AudioRequest_ID") %>' class="btn btn-gradient-primary " title="Xem chi tiết">Chi tiết</a>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
