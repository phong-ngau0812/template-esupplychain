<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="RequestProductBrand_List.aspx.cs" Inherits="RequestProductBrand_List" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Danh sách thay đổi thông tin doanh nghiệp</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0 table-bordered" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped mb-0">
                                                <thead>
                                                    <tr>
                                                        <th width="20%">Tiêu đề chỉnh sửa</th>
                                                        <th width="20%">Thời gian gửi yêu cầu</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <asp:Repeater runat="server" ID="grdData" OnItemDataBound="grdData_ItemDataBound" OnItemCommand="grdData_ItemCommand">
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td><%--<%#Eval("ProductBrandChange_Note") %>--%>Thay đổi thông tin doanh nghiệp
                                                                </td>
                                                                <td>
                                                                    <%# DateTime.Parse( Eval("ProductBrandChange_Date").ToString()).ToString("dd/MM/yyyy hh:mm:ss") %>
                                                                </td>
                                                                <td>
                                                                    <%#new MyUser().FullNameFromUser_ID(Eval("ProductBrandChange_By").ToString())  %>
                                                                </td>
                                                                <td>
                                                                    <%#Eval("Name") %>
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Literal runat="server" ID="lblProductBrandChange_Status" Text='<%#Eval("ProductBrandChange_Status") %>' Visible="false"></asp:Literal>
                                                                    <asp:Literal runat="server" ID="lblProductBrand_ID" Text='<%#Eval("ProductBrand_ID") %>' Visible="false"></asp:Literal>
                                                                    <%--<%#Eval("ProductBrandChange_Status").ToString()=="0"?"<span class='text-danger'> Chưa duyệt</span>":"<span class='text-success'> Đã duyệt</span> " %></td>--%>
                                                                <%#Eval("ProductBrandChange_Status").ToString()=="0"?"<span class='text-danger'> Chưa duyệt</span>": (Eval("ProductBrandChange_Status").ToString()=="2"?"<span class='text-danger'> Không duyệt</span>":"<span class='text-success'> Đã duyệt</span> ") %></td>
                                                                <td align="center">
                                                                    <span>
                                                                        <asp:LinkButton runat="server" ID="btnActive" CommandName="Active" CssClass=" btn btn-success mr-2" ToolTip="Duyệt" CommandArgument='<%#Eval("ProductBrandChange_ID") %>'>Duyệt</asp:LinkButton>
                                                                         <a href='/Admin/ProductBrand/ProductBrand_ChangeEdit?ProductBrandChange_ID=<%#Eval("ProductBrandChange_ID") %>' class="btn btn-gradient-primary " title="Xem chi tiết">Chi tiết</a>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
