<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="RequestProduct_List.aspx.cs" Inherits="RequestProduct_List" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a>Quản lý thay đổi thông tin sản phẩm</a></li>
                                <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Danh sách thay đổi thông tin sản phẩm</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                    ...
                                    <table id="tech-companies-1" class="table table-striped mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <asp:Repeater runat="server" ID="grdData" OnItemDataBound="grdData_ItemDataBound" OnItemCommand="grdData_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td><%# Eval("Product_ID").ToString()=="0"?"Thêm mới sản phẩm":"Thay đổi thông tin sản phẩm" %>
                                                        </td>
                                                        <td>
                                                            <%# DateTime.Parse( Eval("ProductChange_Date").ToString()).ToString("dd/MM/yyyy hh:mm:ss") %>
                                                        </td>
                                                        <td>
                                                            <%#new MyUser().FullNameFromUser_ID(Eval("ProductChange_By").ToString())  %>
                                                        </td>
                                                        <td>
                                                            <%#Eval("Name") %>
                                                        </td>
                                                        <td align="center">
                                                            <asp:Literal runat="server" ID="lblProductChange_Status" Text='<%#Eval("ProductChange_Status") %>' Visible="false"></asp:Literal>
                                                            <asp:Literal runat="server" ID="lblProduct_ID" Text='<%#Eval("Product_ID") %>' Visible="false"></asp:Literal>
                                                            <%#Eval("ProductChange_Status").ToString()=="0"?"<span class='text-danger'> Chưa duyệt</span>": (Eval("ProductChange_Status").ToString()=="2"?"<span class='text-danger'> Không duyệt</span>":"<span class='text-success'> Đã duyệt</span> ") %></td>
                                                        <td align="center">
                                                            <span>
                                                                <asp:LinkButton runat="server" ID="btnActive" CommandName="Active" CssClass=" btn btn-success mr-2" ToolTip="Duyệt" CommandArgument='<%#Eval("ProductChange_ID") %>'>Duyệt</asp:LinkButton>
                                                                <a href='/Admin/Product/Product_ChangeEdit?ProductChange_ID=<%#Eval("ProductChange_ID") %>' class="btn btn-gradient-primary " title="Xem chi tiết">Chi tiết</a>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
