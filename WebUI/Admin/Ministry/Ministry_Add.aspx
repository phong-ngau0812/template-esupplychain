<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Ministry_Add.aspx.cs" Inherits="Ministry_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Ministry_List.aspx">Quản lý bộ</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên bộ <span class="red">*</span></label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập tên bộ"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <label>E-Mail <span class="red">*</span></label>
                                <div>
                                    <asp:TextBox runat="server" ID="txtEmail" ClientIDMode="Static" TextMode="Email" parsley-type="email" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập Email"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtPhone" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập số điện thoại"></asp:TextBox>
                            </div>
                            <!--end form-group-->
