<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Department_Add.aspx.cs" Inherits="Department_Add" ValidateRequest="false" EnableEventValidation="false" %>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên phòng ban/ bộ phận  <span class="red">*</span> </label>
