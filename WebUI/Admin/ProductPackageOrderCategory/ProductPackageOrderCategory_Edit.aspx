<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductPackageOrderCategory_Edit.aspx.cs" Inherits="ProductPackageOrderCategory_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="ProductPackageOrderCategory_List.aspx">Quản lý loại lệnh</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên loại lệnh  <span class =" red">*</span></label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa loại lệnh " ></asp:TextBox>
                            </div>
                           <div class="form-group">
                                <label>Mô tả</label>
