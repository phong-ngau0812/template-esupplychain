<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductPackageOrderCategory_Add.aspx.cs" Inherits="ProductPackageOrderCategory_Add" ValidateRequest="false" EnableEventValidation="false" %>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên loai lệnh <span class =" red">*</span> </label>
