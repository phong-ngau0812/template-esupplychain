<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="SalesInformation_Add.aspx.cs" Inherits="SalesInformation_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <asp:Repeater runat="server" ID="rptMaterial">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtPrice" Text='<%#Eval("Price") %>' ClientIDMode="Static" CssClass="form-control formatMoney"></asp:TextBox></td>
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtUnit" ClientIDMode="Static" CssClass="form-control"></asp:TextBox></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </tbody>
                            ...
                            <div class="form-group mb-0">
                                <asp:Button runat="server" ID="btnSave" ClientIDMode="Static" CssClass="btn btn-gradient-primary waves-effect waves-light" Text="Lưu" OnClick="btnSave_Click" />
