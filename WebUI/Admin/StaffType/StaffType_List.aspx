<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="StaffType_List.aspx.cs" Inherits="StaffType_List" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a>Quản lý nhóm nhân viên </a></li>
                                <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Quản lý nhóm nhân viên </h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                ...
                                <ContentTemplate>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <asp:Repeater runat="server" ID="rptStaffType" OnItemCommand="rptStaffType_ItemCommand" OnItemDataBound="rptStaffType_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td> <a href='StaffType_Edit?StaffType_ID=<%#Eval("StaffType_ID") %>' class="breadcrumb-item active font-15"><%#Eval("Name") %></td>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <a href='StaffType_Edit?StaffType_ID=<%#Eval("StaffType_ID") %>' class="mr-2" title="Sửa thông tin"><i class="fas fa-edit text-success font-16"></i></a>
                                                            <asp:LinkButton runat="server" ID="btnDelete" CommandName="Delete" CssClass="mr-2" ToolTip="Xóa" CommandArgument='<%#Eval("StaffType_ID") %>' OnClientClick="return confirm('Bạn có chắc chắn muốn xóa không?')"><i class="fas fa-trash-alt text-danger font-16"></i></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
