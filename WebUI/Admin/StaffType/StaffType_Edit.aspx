<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="StaffType_Edit.aspx.cs" Inherits="StaffType_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa loại lệnh sản xuất" ></asp:TextBox>
                            </div>
                           <div class="form-group">
                                <label>Mô tả</label>
