<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductPackageOrder_Edit.aspx.cs" Inherits="ProductPackageOrder_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                                            ...
                                            <asp:Repeater runat="server" ID="rptMaterial">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtQuantity" ClientIDMode="Static" Text='<%#Eval("Amount") %>' CssClass="form-control formatMoney"></asp:TextBox></td>
                                                        <td><%#Eval("Unit") %></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
