<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="TestingCertificates_Edit.aspx.cs" Inherits="TestingCertificates_Edit" ValidateRequest="false" EnableEventValidation="false" %>
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div style="margin: 5px 0px;">
									<a href="<%=UploadFile%>" target="_blank">
										<p ><%=UploadFile%></p>
									</a>
								</div>
