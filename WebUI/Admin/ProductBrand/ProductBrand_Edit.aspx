<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductBrand_Edit.aspx.cs" Inherits="ProductBrand_Edit" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group" runat="server" id="HideCapBac">
                                ...
                                <asp:DropDownList runat="server" ID="ddlRank" CssClass="select2 form-control" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn cấp bậc" AutoPostBack="true" OnSelectedIndexChanged="ddlRank_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group" runat="server" id="SoPT" visible="false">
                                <label>Sở phụ trách</label>
                                <asp:DropDownList runat="server" ID="ddlSo" CssClass="select2 form-control"></asp:DropDownList>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlBranch" CssClass="select2 form-control" required data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn ngành" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlChainlink" CssClass="select2 form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlChainlink_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group" runat="server" id="Vaitro" visible="false">
                                <label>Vai trò trong chuỗi</label>
                                <asp:DropDownList runat="server" ID="ddlRoleChain" CssClass="select2 form-control">
                                    <asp:ListItem Text="-- Chọn vai trò trong chuỗi --" Value="-1"></asp:ListItem>
                                    <asp:ListItem Text="Chủ chuỗi" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="Thành viên" Value="1"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label for="ckShowlogo" class="custom-control-label" style="margin: 50px;">
                                            HIỂN THỊ LOGO DOANH NGHIỆP TRÊN TEM TRUY XUẤT
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group" style="width: 200px;">
                                            <asp:TextBox runat="server" ID="txtContractSigningDate" ClientIDMode="Static" CssClass="form-control" name="birthday" Text="" />
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="dripicons-calendar"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <label>Số sản phẩm được tạo</label>
                                        <asp:TextBox runat="server" ID="txtProductCount" ClientIDMode="Static" TextMode="Number" Text="10" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3">
                                        <label>Số tem được tạo 1 năm</label>
                                        <asp:TextBox runat="server" ID="txtStampCount" ClientIDMode="Static" TextMode="Number" Text="10000" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Nhân viên kinh doanh</label>
                                        <asp:DropDownList runat="server" ID="ddlSales" CssClass="select2 form-control"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceBottom" runat="Server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#txtContractSigningDate').daterangepicker({
                singleDatePicker: true,
                showDropdowns: true,
                autoUpdateInput: false,
                //minYear: 1901,
                ...
                $('#txtContractSigningDate').val(start.format('DD/MM/YYYY'));
                //console.log("A new date selection was made: " + start.format('DD/MM/YYYY') + ' to ' + end.format('YYYY-MM-DD'));
            });
        });
    </script>
