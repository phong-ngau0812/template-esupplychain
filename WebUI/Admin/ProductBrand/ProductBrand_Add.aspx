<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductBrand_Add.aspx.cs" Inherits="ProductBrand_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập tên doanh nghiệp"></asp:TextBox>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" runat="server" id="Vaitro" visible="false">
                                ...
                                <asp:DropDownList runat="server" ID="ddlRoleChain" CssClass="select2 form-control">
                                    <asp:ListItem Text="-- Chọn vai trò trong chuỗi --" Value=""></asp:ListItem>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Thông tin truyền thông quản bá</label>
