<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductBrand_Config.aspx.cs" Inherits="ProductBrand_Config" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="ProductBrand_List">Danh sách doanh nghiệp</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Quyền tải lô mã</label>
                                            <div class="custom-control custom-checkbox">
                                                <asp:CheckBox runat="server" ID="ckDownload" ClientIDMode="Static" Checked="true" />
                                                <label for="ckDownload" class="custom-control-label">
                                                    KÍCH HOẠT
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Giới hạn số tem sinh trong 1 tháng</label>
                                            <asp:TextBox runat="server" ID="txtNumber" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceBottom" runat="Server">
    ...
    <script>
        ...
        function Init() {
            ...
            $("#ckDownload").addClass("custom-control-input");
        }
