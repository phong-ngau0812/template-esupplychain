<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="MessageRequest_Edit.aspx.cs" Inherits="Admin_Message_MessageRequest_Edit" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtNote" ClientIDMode="Static" CssClass="form-control" required Enabled="false" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa nhập tiêu đề"></asp:TextBox>
                            </div>
