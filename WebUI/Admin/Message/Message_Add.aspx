<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Message_Add.aspx.cs" Inherits="Admin_Message_Message_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtNote" ClientIDMode="Static" TextMode="MultiLine" Rows="3" CssClass="form-control" required data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa nhập thông điệp"></asp:TextBox>
                            </div>
