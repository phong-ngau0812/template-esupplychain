<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="TaskStepAnswer_Add.aspx.cs" Inherits="TaskStepAnswer_Add" ValidateRequest="false" EnableEventValidation="false" %>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-5" runat="server" id="AddAnswer">
									<hr />
									<h4 style="text-align: center">Thêm mới câu trả lời </h4>
									<div class="form-group">
										<label>Nội dung câu hỏi </label>
										<br />
										<b><%=Question %> </b>
									<%--	<div style = "border: 1px solid #edf0f5;width:100%;height :100px;padding: 10px;overflow: scroll;"> <%=Question %> </div>--%>
									...
									<div class=" form-group" >
										<label>Nội dung câu trả lời <span class="red">*</span></label>
											<asp:TextBox runat="server" ID="txtName" TextMode="MultiLine" Rows="5" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập nội dung"> </asp:TextBox>
								...
								<div class="col-md-7">
									<hr />
									<h4 class ="mb-3" style="text-align: center">Danh sách câu trả lời</h4>
