<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="PageFunction_Add.aspx.cs" Inherits="PageFunction_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="PageFunction_List.aspx">Quản lý page chức năng</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                             ...
                             <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFunction" CssClass="select2 form-control" Width="100%"  AutoPostBack="true" data-parsley-required="true" data-parsley-allselected="true"  data-parsley-required-message="Bạn chưa chọn chức năng" ></asp:DropDownList>
                            </div>

                            <div class="form-group">
                                <label>Tên page chức năng <span class="red">*</span></label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập page chức năng"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <label>URL page chức năng <span class="red">*</span></label>
                                <asp:TextBox runat="server" ID="txtUrl" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập page chức năng"></asp:TextBox>
                            </div>
