<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="PageFunction_Edit.aspx.cs" Inherits="PageFunction_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="PageFunction_List.aspx">Quản lý nhóm chức năng</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <%--bắt sự kiện click, tự động load trang--%>
                            <%-- OnSelectedIndexChanged="ddlFunctionGroupCategory_SelectedIndexChanged" AutoPostBack="true"--%>

                            <div class="form-group">
                                 <label>Tên chức năng <span class="red">*</span></label>
                                <asp:DropDownList runat="server" ID="ddlFunction" CssClass="select2 form-control" Width="100%" data-parsley-required="true" data-parsley-allselected="true"  data-parsley-required-message="Bạn chưa chọn nhóm quyền"></asp:DropDownList>
                            </div>

                            <div class="form-group">
                                <label>Tên page chức năng <span class="red">*</span></label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập tên page chức năng"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <label>Url page chức năng <span class="red">*</span></label>
                                <asp:TextBox runat="server" ID="txtUrl" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn chưa nhập url page chức năng"></asp:TextBox>
                            </div>
                            <!--end form-group-->
