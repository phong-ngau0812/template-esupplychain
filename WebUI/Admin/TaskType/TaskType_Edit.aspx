<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="TaskType_Edit.aspx.cs" Inherits="TaskType_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Tasktype_List.aspx">Quản lý loại nhật ký</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên loại nhật ký <span class =" red">*</span></label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Chưa nhập số điện thoại"></asp:TextBox>
                            </div>
