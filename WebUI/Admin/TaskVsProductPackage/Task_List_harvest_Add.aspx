<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="Task_List_harvest_Add.aspx.cs" Inherits="Task_List_Selling_Add" %>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlWarehouse" CssClass="form-control select2" required data-parsley-required-message="Bạn chưa chọn kho" OnSelectedIndexChanged="ddlWarehouse_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
