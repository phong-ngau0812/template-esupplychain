...
public partial class Task_List_Manufacturing_Add : System.Web.UI.Page
{
    ...
    protected void FillTask(int Product_ID)
    {
        try
        {
            ...
            DataTable dt = new DataTable();
            dt = BusinessRulesLocator.GetTaskStepBO().GetAsDataTable(" Product_ID=" + Product_ID + where, " SORT ASC");
    ...
    protected void FillDllStatus()
    {
        ...
        {
            DataTable dt = new DataTable();
            dt = BusinessRulesLocator.GetTaskStatusBO().GetAsDataTable("", "TaskStatus_ID DESC ");
    ...
    protected void SetDateTask()
    {
            ...
            if (ddlTask.SelectedValue != "")
            {
                ...
                if (dt.Rows.Count == 1)
                {
                    ...
                    if (dt.Rows[0]["EndTime"] != null)
                    {
                        ...
                        txtEnd.Text = DateTime.Parse(dt.Rows[0]["EndTime"].ToString()).ToString("dd/MM/yyyy HH:mm:ss");
                    }
                    else
                    {
        ...
        catch (Exception ex)
        {
            ...
            Log.writeLog("SetDateTask", ex.ToString());
        }
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                if (_TaskRow != null)
                {
                    ...
                    _NotificationRow.Url = "/Admin/TaskVsProductPackage/Task_List_Manufacturing_Edit?Task_ID=" + _TaskRow.Task_ID + "&ProductPackage_ID=" + ProductPackage_ID;
                    ...
                    if (!_NotificationRow.IsNotification_IDNull)
                    {
                        ...
                        _NotificationRow.Url = "/Admin/TaskVsProductPackage/Task_List_Manufacturing_Edit?Task_ID=" + _TaskRow.Task_ID + "&ProductPackage_ID=" + ProductPackage_ID + "&Notification_ID=" + _NotificationRow.Notification_ID;
