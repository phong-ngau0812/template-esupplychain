<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="Task_List_Selling_List.aspx.cs" Inherits="Task_List_Selling_List" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Nhật ký bán hàng - Lô <%=name %></h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                                ...
                                                <ItemTemplate>
                                                    <tr class='<%#Eval("StatusName").ToString()!="Đã hoàn thành" ?"table-danger":"" %>'>
                                                        <td>
                                                            ...
                                                            <br />
                                                            <b>&diams; Lý do (Why):</b>
                                                            <a href='Task_List_Selling_Edit?Task_ID=<%#Eval("Task_ID") %>&ProductPackage_ID=<%#Eval("ProductPackage_ID") %>' class="breadcrumb-item active font-15"><%#Eval("Name") %></a>
                                                                <br />
                                                            <a href='Task_List_Selling_Edit?Task_ID=<%#Eval("Task_ID") %>&ProductPackage_ID=<%#Eval("ProductPackage_ID") %>'>
                                                      ...
                                                      <%--  <td><%#Eval("UserName") %>
                                                        ...
                                                        <td align="center">
                                                            <a href='Task_List_Selling_Edit?Task_ID=<%#Eval("Task_ID") %>&ProductPackage_ID=<%#Eval("ProductPackage_ID") %>' class="mr-2" title="Sửa thông tin"><i class="fas fa-edit text-success font-16"></i></a>
