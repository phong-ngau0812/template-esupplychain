<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="Task_List_Manufacturing_Add.aspx.cs" Inherits="Task_List_Manufacturing_Add" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Thêm mới nhật ký sản xuất - Lô <%=name %></h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" runat="server" id="ChooseItem">
                                ...
                                <telerik:RadComboBox RenderMode="Lightweight" MaxHeight="300px" ID="ddlItem" Skin="MetroTouch" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="100%" EmptyMessage="Tất cả cá thể " Localization-ItemsCheckedString="cá thể được chọn" EnableAutomaticLoadOnDemand="True" ItemsPerRequest="50"
                                    ShowMoreResultsBox="true" EnableVirtualScrolling="true" DataTextField="QRCodePublicContent"
                                    DataValueField="ProductItem_ID" DataSourceID="SqlDataSource1">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MainConnectionString %>" SelectCommand="SELECT [ProductItem_ID], [QRCodePublicContent] FROM [ProductItem] WHERE ([ProductPackage_ID] = @ProductPackage_ID)" ProviderName="<%$ ConnectionStrings:MainConnectionString.ProviderName %>">
                                <SelectParameters>
                                    <asp:QueryStringParameter DefaultValue="0" Name="ProductPackage_ID" QueryStringField="ProductPackage_ID" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            ...
                            <%-- <asp:UpdatePanel runat="server" ID="up">
                                        <ContentTemplate>
                                            ...
                                            <table id="datatableNoSort" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th width="60%">Đầu mục công việc</th>
                                                        <th width="20%">Ngày thực hiện</th>
