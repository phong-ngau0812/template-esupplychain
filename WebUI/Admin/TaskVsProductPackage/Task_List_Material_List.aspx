<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="Task_List_Material_List.aspx.cs" Inherits="Task_List_Material_List" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Nhật ký vật tư - Lô <%=name %></h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                    ...
                                    <table id="datatableNoSort" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                                ...
                                                <ItemTemplate>
                                                    <tr class='<%#Eval("StatusName").ToString()!="Đã hoàn thành" ?"table-danger":"" %>'>
                                                        <td>
                                                            ...
                                                            <br />
                                                            <b>&diams; Lý do (Why):</b>
                                                            <a href='Task_List_Material_Edit?Task_ID=<%#Eval("Task_ID") %>&ProductPackage_ID=<%#Eval("ProductPackage_ID") %>' class="breadcrumb-item active font-15"><%#Eval("Name") %></a>
                                                            <br />
                                                            <br />
                                                            <a href='Task_List_Material_Edit?Task_ID=<%#Eval("Task_ID") %>&ProductPackage_ID=<%#Eval("ProductPackage_ID") %>'>
                                                                <span class="btn btn-warning">Xem chi tiết</span>
                                                            </a>
                                                        </td>
                                                        <td><%#decimal.Parse( Eval("Quantity").ToString()).ToString("N2") %> <%#Eval("Unit") %></td>
                                                        <td><%#decimal.Parse( Eval("Price").ToString()).ToString("N0") %></td>
                                                        <td><%#(decimal.Parse( Eval("Price").ToString())*decimal.Parse( Eval("Quantity").ToString()) ).ToString("N0") %>
                                                        ...
                                                        <td align="center">
                                                            <a href='Task_List_Material_Edit?Task_ID=<%#Eval("Task_ID") %>&ProductPackage_ID=<%#Eval("ProductPackage_ID") %>' class="mr-2" title="Sửa thông tin"><i class="fas fa-edit text-success font-16"></i></a>
                                            ...
                                            <tr class="table-warning">
                                                ...
                                                <td colspan="3"><%=TotalThuhoach.ToString("N0") %></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </ContentTemplate>
