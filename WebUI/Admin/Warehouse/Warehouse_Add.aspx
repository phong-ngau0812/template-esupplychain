<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Warehouse_Add.aspx.cs" Inherits="Warehouse_Add" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlProductBrand" CssClass="select2 form-control" Width="100%" OnSelectedIndexChanged="ddlProductBrand_SelectedIndexChanged" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Bạn chưa chọn doanh nghiệp"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlDepartment" CssClass="select2 form-control"></asp:DropDownList>
                            </div>
                            <div class="form-group">
