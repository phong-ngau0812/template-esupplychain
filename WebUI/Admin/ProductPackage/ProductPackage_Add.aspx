<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="ProductPackage_Add.aspx.cs" Inherits="ProductPackage_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="page-title-box">
                        ...
                        <div class="radio radio-primary row-cols-lg-2" style="width: 100%; display: inline-flex">
                            <div class="custom-control custom-radio">
                                <asp:RadioButton runat="server" Checked="true" ID="AddLoSanXuat" AutoPostBack="true" GroupName="rdo" Text="Thêm mới lô sản xuất"></asp:RadioButton>
                            </div>
                            <div class="custom-control custom-radio none">
                                <asp:RadioButton runat="server" ID="AddLoCheBien" AutoPostBack="true" GroupName="rdo" Text="Thêm mới lô chế biến"></asp:RadioButton>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-6">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="up">
                                        <ContentTemplate>
                                            ...
                                            <div class="form-group">
                                                <label>Tên lô <span style="color: red;">*</span></label>
                                                <%-- <asp:TextBox runat="server" ID="TextBox1" ClientIDMode="Static" CssClass="form-control" placeholder="Tự động..." Enabled="false" Visible="true"></asp:TextBox>--%>
                                                <asp:TextBox runat="server" ID="txtNamePackage" ClientIDMode="Static" CssClass="form-control" placeholder="Nhập tên lô" required data-parsley-required-message="Chưa nhập tên lô"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group none">
                                                ...
                                                <asp:DropDownList runat="server" ID="ddlCha" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlCha_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                            ...
                                            <asp:Panel runat="server" ID="muntipleproduct" Visible="false">
                                                <div class="form-group">
                                                    <label>Sản phẩm<span class="red">*</span> </label>
                                                    <asp:ListBox runat="server" ClientIDMode="Static" ID="ddlProductmultiple" AutoPostBack="true" OnSelectedIndexChanged="ddlProductmultiple_SelectedIndexChanged" SelectionMode="Multiple" CssClass="select2 form-control" Width="100%" data-placeholder="&nbsp;&nbsp;-- Chọn sản phẩm  --"></asp:ListBox>
                                                </div>
                                            </asp:Panel>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceBottom" runat="Server">
    ...
    <script>
        ...
        function Init() {
            ...
            $('#timepickerEnd2').bootstrapMaterialDatePicker({
                format: 'HH:mm', time: true, date: false
            });
