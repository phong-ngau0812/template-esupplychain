<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="PO_Add.aspx.cs" Inherits="Admin_POManage_PO_Add" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlProductBrand" CssClass="form-control select2" data-parsley-required="true" AutoPostBack="true" ClientIDMode="Static" OnSelectedIndexChanged="ddlProductBrand_SelectedIndexChanged" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn doanh nghiệp"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                        ...
                                        <asp:Repeater runat="server" ID="rptProduct">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox runat="server" ID="txtContent" ClientIDMode="Static" CssClass="form-control" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <telerik:RadDatePicker RenderMode="Lightweight" ID="RadDatePicker1" Width="70%" runat="server"></telerik:RadDatePicker>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><%--<%#decimal.Parse(Eval("Price").ToString()).ToString("N0") %>--%>
                                                        <asp:TextBox runat="server" ID="txtPrice" ClientIDMode="Static" CssClass="form-control formatMoney" Text="0"></asp:TextBox>

                                                    </td>
                                                    <td>
                                                        <asp:TextBox runat="server" ID="txtTotalPrice" ClientIDMode="Static" CssClass="form-control box-price" Text="0"></asp:TextBox>
                                                    </td>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
