<%@ Page Title="" Language="C#" MasterPageFile="~//Template/CMS.master" AutoEventWireup="true" CodeFile="ProductCategory_List.aspx.cs" Inherits="ProductCategory_List" %>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td >
                                                            ...
                                                            <asp:Literal runat="server" ID="lblID" Text='<%#Eval("ProductCategory_ID") %>' Visible="false"></asp:Literal>
