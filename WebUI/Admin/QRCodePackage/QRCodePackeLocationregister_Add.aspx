<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="QRCodePackeLocationregister_Add.aspx.cs" Inherits="QRCodePackeLocationregister_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">Thông tin phân vùng sản phẩm lô:<%=NameProductPackage %> </li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-10">
                                        <label>Địa danh <span class="red">*</span> </label>
                                    ...
                                    <div class="form-group  col-lg-10 ">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label for="ckActive" class="custom-control-label" style="margin-left: 30.8%;">
                                                Cảnh báo vị trí
                                            </label>
                                        </div>
                                    </div>
