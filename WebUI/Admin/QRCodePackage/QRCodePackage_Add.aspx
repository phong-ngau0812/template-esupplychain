<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="QRCodePackage_Add.aspx.cs" Inherits="QRCodePackage_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" Async="true" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row" runat="server" id="productPackage">
                                ...
                                <div class="col-lg-9">
                                    <asp:DropDownList runat="server" ID="ddlProductPackage" AutoPostBack="true" OnSelectedIndexChanged="ddlProductPackage_SelectedIndexChanged1" ClientIDMode="Static" CssClass="select2 form-control"></asp:DropDownList>
                                    <br />
