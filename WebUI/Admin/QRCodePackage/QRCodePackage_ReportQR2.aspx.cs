...
public partial class Admin_QRCodePackage_QRCodePackage_ReportQR2 : System.Web.UI.Page
{
    ...
    private void LoadProductPackage()
    {
        try
        {
            ...
            dtSet = BusinessRulesLocator.Conllection().GetQRCodePackageReportQR2(1, pageSize, 7, Convert.ToInt32(ddlProduct.SelectedValue), Convert.ToInt32(ddlProductBrand.SelectedValue), Convert.ToInt32(ddlProductPackage.SelectedValue), Convert.ToInt32(ddlSo.SelectedValue), Convert.ToInt32(ddlLocation.SelectedValue), Convert.ToInt32(ddlDistrict.SelectedValue), Convert.ToInt32(ddlWard.SelectedValue), ctlDatePicker1.FromDate, ctlDatePicker1.ToDate);
    ...
    {
        //int ProductBrand_ID = 0;
        DataSet dtSet = BusinessRulesLocator.Conllection().GetQRCodePackageReportQR2(1, 9999, 7, Convert.ToInt32(ddlProduct.SelectedValue), Convert.ToInt32(ddlProductBrand.SelectedValue), Convert.ToInt32(ddlProductPackage.SelectedValue), Convert.ToInt32(ddlSo.SelectedValue), Convert.ToInt32(ddlLocation.SelectedValue), Convert.ToInt32(ddlDistrict.SelectedValue), Convert.ToInt32(ddlWard.SelectedValue), ctlDatePicker1.FromDate, ctlDatePicker1.ToDate);
        ...
        dt.Columns["UsedName"].ColumnName = "Tên người sở hữu";
        dt.Columns["UsedPhone"].ColumnName = "Số điện thoại";
        dt.Columns["UsedIdentityCard"].ColumnName = "CMND";
        dt.Columns["UsedAddress"].ColumnName = "Địa chỉ";
        dt.Columns.Remove("QRCodeContent");
        dt.Columns.Remove("ProductPackage_ID");

        dt.AcceptChanges();
        string attachment = "attachment; filename=Bao_cao_san_pham_da_xac_thuc_tem_lop_2_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + ".xls";
        Response.ClearContent();
        Response.AddHeader("content-disposition", attachment);
        Response.ContentEncoding = System.Text.Encoding.Unicode;
        Response.BinaryWrite(System.Text.Encoding.Unicode.GetPreamble());
        Response.ContentType = "application/vnd.ms-excel";
        string tab = "Báo cáo sản phẩm đã xác thực tem lớp 2 \nThời gian báo cáo từ ngày: " + ctlDatePicker1.FromDate.ToString("dd-MM-yyyy") + " đến ngày: " + ctlDatePicker1.ToDate.ToString("dd-MM-yyyy") + " \n";
