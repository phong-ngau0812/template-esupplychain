<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="QRCodePackeWorkshopregister_Add.aspx.cs" Inherits="QRCodePackeWorkshopregister_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
				...
				<div class="col-sm-12">
					<div class="page-title-box">
						<div class="float-right">
							<ol class="breadcrumb">
								<li class="breadcrumb-item active">Quản lý phân kho :<%=NameProductPackage %> </li>
								<li class="breadcrumb-item"><a href="QRCodePackage_List">Quản lý lô mã </a></li>
								<li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
							</ol>
						</div>
						<h4 class="page-title">Thêm mới phân kho cho lô:<%=NameProductPackage %> </h4>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="form-group col-lg-10">
										<label>Tên nhân viên/hộ sản xuất <span class="red">*</span> </label>
										 <asp:DropDownList runat="server" ID="ddlWorkshop" CssClass="select2 form-control" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn kho"></asp:DropDownList>
									</div>
									...
									<div class="form-group col-lg-10">
										...
										<asp:TextBox CssClass="form-control" runat="server" ID="txtList" Enabled ="false" TextMode="MultiLine" Rows="4" onKeyUp="countLines(this)"></asp:TextBox>
