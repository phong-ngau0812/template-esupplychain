<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="QRCodePackage_ReportQR2.aspx.cs" Inherits="Admin_QRCodePackage_QRCodePackage_ReportQR2" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a>Báo cáo sản phẩm đã xác thực tem lớp 2</a></li>
                                <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Báo cáo sản phẩm đã xác thực tem lớp 2</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                            ...
                                            <table id="tech-companies-1" class="table table-striped mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="7%" class="text-center">Ngày tạo mã</th>
                                                        <th width="10%" class="text-center">Vị trí xác thực</th>
                                                    ...
                                                    <asp:Repeater runat="server" ID="grdProductPackage">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><%#Eval("UsedName") %></td>
                                                                <td><%#Eval("UsedPhone") %></td>
                                                                <td><%#Eval("UsedIdentityCard") %></td>
                                                                <td><%#Eval("UsedAddress") %></td>
                                                            </tr>
