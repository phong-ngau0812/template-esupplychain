<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="QRCodePackeCustomerregister_Add.aspx.cs" Inherits="QRCodePackeCustomerregister_Add" ValidateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
				...
				<div class="col-sm-12">
					<div class="page-title-box">
						<div class="float-right">
							<ol class="breadcrumb">
								<li class="breadcrumb-item active">Quản lý phân tem cho khách hàng </li>
								<li class="breadcrumb-item"><a href="QRCodePackage_List">Quản lý lô mã </a></li>
								<li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
							</ol>
						</div>
						<h4 class="page-title">Thêm mới phân khách hàng cho lô tem: <%=NameProductPackage %> </h4>
								...
								<div class="col-lg-12">
									...
									<div class="form-group col-lg-10">
										...
										<div class="radio radio-primary">
											<asp:RadioButton runat="server" ID="rdoLienMach" Text="Chia theo chuỗi Serial liền mạch" GroupName="rdo" Checked="true" AutoPostBack="true" OnCheckedChanged="rdoLienMach_CheckedChanged" />&nbsp;&nbsp;&nbsp;
											<asp:RadioButton runat="server" ID="rdoKhongLienMach" Text="Chia theo Serial không liền mạch" GroupName="rdo" AutoPostBack="true" OnCheckedChanged="rdoKhongLienMach_CheckedChanged" />
										</div>
									</div>

									<div class="form-group col-lg-10">
										<label>Tên khách hàng <span class="red">*</span> </label>
										<asp:DropDownList runat="server" ID="ddlCustomerregister" CssClass="select2 form-control" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Chưa chọn khách hàng"></asp:DropDownList>
									</div>
									...
									<div class="form-group col-lg-10">
										...
										<asp:TextBox CssClass="form-control" runat="server" ID="txtList" TextMode="MultiLine" Rows="4" Enabled ="false" onKeyUp="countLines(this)"></asp:TextBox>
