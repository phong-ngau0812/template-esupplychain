<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="Area_Edit.aspx.cs" Inherits="Area_Edit" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="Area_List.aspx">Quản lý khu sản xuất </a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlProductBrand" CssClass="select2 form-control" Width="100%" AutoPostBack=" true" OnSelectedIndexChanged="ddlProductBrand_SelectedIndexChanged" data-parsley-required="true" data-parsley-allselected="true" data-parsley-required-message="Bạn chưa chọn doanh nghiệp"></asp:DropDownList>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Tên vùng sản xuất </label>
                                <asp:DropDownList runat="server" ID="ddlZone" CssClass="select2 form-control" Width="100%"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label>Mã GLN khu</label>
                            ...
                            <div class="form-group">
                                <label>Tên khu sản xuất <span style="color: red; font-size: 15px">*</span> </label>
                                <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" required data-parsley-required-message="Bạn nhập tên khu vực sản xuất"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-2">
