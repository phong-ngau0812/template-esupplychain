<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CMS.master" AutoEventWireup="true" CodeFile="User_History.aspx.cs" Inherits="Admin_User_User_History" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a>Quản lý lịch sử đăng nhập</a></li>
                                <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Lịch sử đăng nhập</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row none">
                                <div class="col-lg-3 col-xs-12 mb-2" id="kd1" runat="server">
                                    <asp:DropDownList runat="server" ID="ddlProductBrand" CssClass="select2 form-control"></asp:DropDownList>
                                </div>
                                <div class="col-lg-3 col-xs-12 mb-2" id="kd2" runat="server">
                                    <asp:DropDownList runat="server" ID="ddlType" CssClass="select2 form-control"></asp:DropDownList>
                                </div>
                                <div class="col-lg-3 col-xs-12 mb-2" id="kd3" runat="server">
                                    <asp:DropDownList runat="server" ID="ddlDepartmentUser" CssClass="select2 form-control"></asp:DropDownList>
                                </div>

                                <div class="col-lg-3 col-xs-12 mb-2" runat="server" id="FillFunctionGroup" visible="false">
                                    <asp:DropDownList runat="server" ID="ddlFunctionGroup" CssClass="select2 form-control"></asp:DropDownList>
                                </div>
                                                ...
                                                <tbody>
                                                    <asp:Repeater runat="server" ID="rptFarm" OnItemDataBound="rptFarm_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal runat="server" ID="lblName" Text='<%#Eval("Name")%>' Visible="false"></asp:Literal>
                                                                    Người dùng <b><%#Eval("Name").ToString().Split('-')[1]%></b><asp:Literal runat="server" ID="lblProductBrand"></asp:Literal>
                                                                    vừa đăng nhập
																	<br />
                                                                    <small><%#DateTime.Parse( Eval("CreateDate").ToString()).ToString("dd/MM/yyyy HH:mm:ss")%></small></td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                </tbody>
