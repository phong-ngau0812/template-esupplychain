<%@ page title="" language="C#" masterpagefile="~//Template/CMS.master" autoeventwireup="true" inherits="User_List, App_Web_00zkwi3t" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-xs-12 mb-2" id="kd1" runat="server">
                                ...
                                <div class="col-lg-3 col-xs-12 mb-2" id="kd2" runat="server">
                                ...
                                <div class="col-lg-3 col-xs-12 mb-2" id="kd3" runat="server">
                                ...
                                <div class="col-lg-3 col-xs-12 mb-2 right " runat="server" id="AddAccountProductBrand" visible="false">
                                            ...
                                            <asp:Repeater runat="server" ID="rptUser" OnItemCommand="rptUser_ItemCommand" OnItemDataBound="rptUser_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><%# new MyUser().AvatarFromUserName(Eval("UserName").ToString())%></td>
                                                        <td><%#Eval("Email") %></td>
                                                        <td><%# new MyUser().PhoneFromUserName(Eval("UserName").ToString())%></td>
                                                        <td><%# new MyUser().OnlineStatus(Eval("UserName").ToString())%></td>
                                                        <td align="center">
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="btnDelete" CommandName="Delete" CssClass="mr-2" ToolTip="Xóa" CommandArgument='<%#Eval("UserName")%>' Visible='<%#MyActionPermission.CanDeleteUser(Eval("UserName").ToString(), ref Message) %>' OnClientClick="return confirm('Bạn có chắc chắn muốn xóa không?')"><i class="fas fa-trash-alt text-danger font-16"></i></asp:LinkButton>
