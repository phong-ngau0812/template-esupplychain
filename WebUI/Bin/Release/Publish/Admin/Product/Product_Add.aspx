<%@ page title="" language="C#" masterpagefile="~/Template/CMS.master" autoeventwireup="true" inherits="Product_Add, App_Web_quwo134q" validaterequest="false" enableeventvalidation="false" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtNangSuat1" ClientIDMode="Static" CssClass="form-control" placeholder="Ví dụ: KG, quả, cái,...."></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
