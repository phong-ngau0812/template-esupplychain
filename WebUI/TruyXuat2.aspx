<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TruyXuat2.aspx.cs" Inherits="TruyXuat2" %>
...
<body>
    ...
    <form runat="server" id="Form1">
        ...
        <div runat="server" id="Data">
            <div runat="server" id="divLanDau" class="mt-3">


                <div class="col-12 text-center">
                    <h4>NHẬP THÔNG TIN SỞ HỮU VÀ BẢO HÀNH SẢN PHẨM</h4>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label>Họ tên</label>
                        <input type="text" class="form-control" id="txtFullNameBH" />
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="txtPhoneBH" />
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label>Số CMND</label>
                        <input type="text" class="form-control" id="txtCMNDBH" />
                ...
                <div class="col-12">
                    <div class="form-group">
                        <label>Địa chỉ</label>
                        <input type="text" class="form-control" id="txtAddressBH" />
                    </div>
                </div>
                <%-- <div class="col-12">
                    <div class="form-group">
                        <label>Model sản phẩm</label>
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtModel"></asp:TextBox>
                    </div>
                </div>--%>
                <div class="col-12">
                    <div class="form-group">
                        <label>Số phiếu bảo hành</label>
                        <input type="text" class="form-control" id="txtPhieuBH" />
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label>Tên cửa hàng bán</label>
                ...
                <div class="col-12">
                    <div class="form-group text-center ">
                        ...
                        <button type="button" class="btn btn-primary" onclick="SaveBH();">Gửi thông tin sở hữu và bảo hành sản phẩm</button>
            ...
            <hr />
            <div id="divlanSau" runat="server" class="mt-3">

                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h5>THÔNG TIN NGƯỜI ĐÃ SỞ HỮU VÀ BẢO HÀNH SẢN PHẨM</h5>
                            <hr />
                        </div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Người sở hữu:</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRName %></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Ngày xác thực</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRDate %></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Số điện thoại</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRSDT %></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Số CMND</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRCMND %></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Địa chỉ</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRAddress %></div>
                    </div>
                </div>
                <%--  <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Model sản phẩm</div>
                        <div class="col-md-9 col-12 font-weight-bold"></div>
                    </div>
                </div>--%>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Số phiếu bảo hành</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRBH %></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h5>THÔNG TIN ĐẠI LÝ CUNG CẤP SẢN PHẨM</h5>
                            <hr />
                        </div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12 ">Tên cửa hàng</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRStore %></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-3 col-12">Địa chỉ</div>
                        <div class="col-md-9 col-12 font-weight-bold"><%=QRStoreAddress %></div>
                    </div>
                </div>
            </div>
            <hr />
            ...
            <section class="section3">
                <ul class="d-flex menu3 d-flex justify-content-around p-0 m-0">
                    ...
                    <li class="menu3-son son2 col-4 d-flex justify-content-center <%=none1 %>">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><%#Eval("Description") %>
                                                                        ...
                                                                        <br />
                                                                        <%# string.IsNullOrEmpty(Eval("Image").ToString())?"":"<img src='../../quantri/data/task/"+Eval("Image")+"'/>" %>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
        ...
        <asp:HiddenField runat="server" ID="lblAddress" Value="" ClientIDMode="Static" />
...
<script>
    ...
    function SaveBH() {
        if (ValidateBH()) {
            var data = {
                name: $("#txtFullNameBH").val(),
                phone: $("#txtPhoneBH").val(),
                cmnd: $("#txtCMNDBH").val(),
                address: $("#txtAddressBH").val(),
                bh: $("#txtPhieuBH").val(),
            ...
            $.ajax({
                url: "/WebServices/QRCodePackage.asmx/SaveBH",
                data: JSON.stringify(data),
                type: "POST",
                contentType: "application/json;charset=utf-8",
                //processData: false,
                ...
                success: function (result) {
                    if (result.d != "") {
                        ...
                        $('#divLanDau input').attr('readonly', true);
    ...
    function SaveInfo() {
        ...
        if (name.length < 1) {
            ...
            alert('Vui lòng nhập bình luận từ 20 ký tự trở lên!')
            $("#txtContent").focus();
        }
        else {
            // PushCM();
